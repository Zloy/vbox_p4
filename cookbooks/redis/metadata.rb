...
description 'Redis: a fast, flexible datastore offering an extremely '\
'useful set of data structure primitives'
...
recipe 'redis::install_from_package', 'Install From Ubuntu Package '\
'-- easy but lags in version'
...
attribute 'redis/log_dir',
          ...
          description: 'Path to the log directory when daemonized -- will'\
          'be stored in [log_dir]/redis.log.',
...
attribute 'redis/release_url',
          ...
          description: 'If using the install_from_release strategy, the '\
          'URL for the release tarball',
          default: 'http://redis.googlecode.com/files/redis-:version:.tar'\
          '.gz'

attribute 'redis/glueoutputbuf',
          display_name: 'Redis output buffer coalescing',
          description: 'Glue small output buffers together into larger TCP'\
          'packets.',
          default: 'yes'

attribute 'redis/saves',
          display_name: 'Redis disk persistence policies',
          description: 'An array of arrays of time, changed objects '\
          'policies for persisting data to disk.',
          type: 'array',
          default: [%w(900 1), %w(300 10), %w(60 10000)]

attribute 'redis/slave',
          display_name: 'Redis replication slave',
          description: 'Act as a replication slave to a master redis '\
          'database.',
          default: 'no'

attribute 'redis/shareobjects',
          display_name: "Redis shared object compression (default: \"no\")",
          description: 'Attempt to reduce memory use by sharing storage '\
          'for substrings.',
          default: 'no'
...
attribute 'redis/server/timeout',
          ...
          description: 'Timeout, in seconds, for disconnection of idle '\
          'clients.',
          default: '300'
